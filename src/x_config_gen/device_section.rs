...
impl fmt::Display for DeviceSectionElement {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            DeviceSectionElement::Comment(value) => writeln!(f, "# {}", value),
            DeviceSectionElement::Identifier(value) => writeln!(f, "Identifier \"{}\"", value),
            DeviceSectionElement::Vendor(value) => writeln!(f, "Vendor \"{}\"", value),
            DeviceSectionElement::Board(value) => writeln!(f, "Board \"{}\"", value),
            DeviceSectionElement::Chipset(value) => writeln!(f, "Chipset \"{}\"", value),
            DeviceSectionElement::Card(value) => writeln!(f, "Card \"{}\"", value),
            DeviceSectionElement::Driver(value) => writeln!(f, "Driver \"{}\"", value),
            DeviceSectionElement::RamDac(value) => writeln!(f, "Ramdac \"{}\"", value),
            DeviceSectionElement::DacSpeed(values) => {
                let values: String = values.iter().map(|i| format!("{} ", i)).collect();
                writeln!(f, "Dacspeed {}", values)
            }
            DeviceSectionElement::VideoRam(value) => writeln!(f, "VideoRam {}", value),
            DeviceSectionElement::MemBase(value) => writeln!(f, "MemBase {}", value),
            DeviceSectionElement::IoBase(value) => writeln!(f, "MemBase {}", value),
            DeviceSectionElement::ClockChip(value) => writeln!(f, "ClockChip \"{}\"", value),
            DeviceSectionElement::ChipId(value) => writeln!(f, "ChipID {}", value),
            DeviceSectionElement::ChipRev(value) => writeln!(f, "ChipRev {}", value),
            ...
            DeviceSectionElement::MatchSeat(value) => writeln!(f, "MatchSeat \"{}\"", value),
            DeviceSectionElement::BusId(value) => writeln!(f, "BusID \"{}\"", value),
            DeviceSectionElement::Irq(value) => writeln!(f, "IRQ {}", value),
            DeviceSectionElement::Screen(value) => writeln!(f, "IRQ {}", value),
        }
    }
}
...
impl DeviceSection {
    ...
    create_function!(
        set_identifier,
        &str,
        DeviceSectionElement::Identifier,
        has_identifier
    );
    ...
    create_function!(
        set_dacspeed,
        &Vec<i32>,
        DeviceSectionElement::DacSpeed,
        has_dacspeed
    );
    create_function!(
        set_videoram,
        i32,
        DeviceSectionElement::VideoRam,
        has_videoram
    );
    ...
    create_function!(
        set_clockship,
        &str,
        DeviceSectionElement::ClockChip,
        has_clockchip
    );
    ...
    create_function!(
        set_clocks,
        &Vec<i32>,
        DeviceSectionElement::Clocks,
        has_clocks
    );
    create_function!(
        set_matchset,
        &str,
        DeviceSectionElement::MatchSeat,
        has_matchseat
    );
...
#[cfg(test)]
mod tests {
    use crate::x_config_gen::device_section::{DeviceSection, DeviceSectionElement};
